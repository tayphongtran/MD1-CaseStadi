    ...
    songs: [
        {
            ...
            image: "./image/CTCHT1.jpg"

        },
        {
            name: "LosayByeLaBye",
            singer: "Lemese-changg",
            path: "./songs/LoSayByeLaBye.mp3",
            image: "./image/Lemese-changg.jpg"
        },
        {
            name: "Răng Khôn",
            singer: "Phí Phương Anh",
            path: "./songs/RangKhon.mp3",
            image: "./image/PhiPhuongAnh.jpg"
        },
        {
            name: "Nàng Thơ",
            singer: "Hoàng Dũng",
            path: "./songs/NangTho.mp3",
            image: "./image/HoangDung.jpg"
        },
        {
            name: "Sài Gòn Đau Lòng Quá",
            singer: "HKT-Hoàng Duyên",
            path: "./songs/SaiGonDauLongQua.mp3",
            image: "./image/HKT-HD.jpg"
        },
        {
            name: "Muộn Rồi Mà Sao Còn",
            singer: "Sơn Tùng M-TP",
            path: './songs/MuonRoiMaSaoCon.mp3',
            image: "./image/MRSCMTP.jpg"
        },
        {
            name: "Tay Trái Chỉ Trăng",
            singer: "Phan Ngọc Luân",
            path: './songs/TayTraiChiTrang.mp3',
            image: "./image/TTCT.jpg"
        }
    ],
